      ...
      <div className=" bg-gray-700 w-full flex-col h-screen flex justify-center items-center">
       <p className="text-3xl font-bold text-center text-balck">
        ...
        <h1 className=" font-semibold text-xl">Enter the password</h1>
          <input placeholder=" Enter the Password" type="password"  className=" border p-2 border-black h-8 rounded-lg" onChange={(e)=>{setpass(e.target.value)}}/>
          ...
          >
            ...
            <div className="mt-2">
              {!team?.ThirdReview ? (
                ...
                <div>
                  <div>
                    {Object.keys(team.ThirdReview).map((i) => (
                      <p key={i}>
                        {i} : {team.ThirdReview[i]}
                      </p>
                    ))}
                    <p>Total Score: {team.ThirdReviewScore}</p>
                  </div>
                  <p>Done!</p>
                </div>
              )}
